...
ActiveRecord::Schema.define(version: 2020_01_29_151730) do
  ...
  create_table "admincontrols", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
  ...
  create_table "custom_threads", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "title"
